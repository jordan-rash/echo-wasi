...
func WasiLoggingLoggingLog(level WasiLoggingLoggingLevel, context string, message string) {
  ...
  var lower_context C.echo_string_t
  ...
  defer C.echo_string_free(&lower_context)
  var lower_message C.echo_string_t
  
  // use unsafe.Pointer to avoid copy
  lower_message.ptr = (*uint8)(unsafe.Pointer(C.CString(message)))
  lower_message.len = C.size_t(len(message))
  defer C.echo_string_free(&lower_message)
...
func WasiPollPollPollOneoff(in []uint32) []bool {
  var lower_in C.echo_list_wasi_poll_poll_pollable_t
  if len(in) == 0 {
    lower_in.ptr = nil
    lower_in.len = 0
  } else {
  ...
  defer C.echo_list_wasi_poll_poll_pollable_free(&lower_in)
  var ret C.echo_list_bool_t
...
func WasiIoStreamsRead(this uint32, len uint64) Result[WasiIoStreamsTuple2ListU8TWasiIoStreamsStreamStatusT, struct{}] {
  ...
  var ret C.echo_result_tuple2_list_u8_wasi_io_streams_stream_status_void_t
  ...
  if ret.is_err {
    ...
    lift_ret_ptr := *(*C.echo_tuple2_list_u8_wasi_io_streams_stream_status_t)(unsafe.Pointer(&ret.val))
...
func WasiIoStreamsSkip(this uint32, len uint64) Result[WasiIoStreamsTuple2U64WasiIoStreamsStreamStatusT, struct{}] {
  ...
  lower_this = lower_this_val
  lower_len := C.uint64_t(len)
  var ret C.echo_result_tuple2_u64_wasi_io_streams_stream_status_void_t
  ...
  if ret.is_err {
    ...
    lift_ret_ptr := *(*C.echo_tuple2_u64_wasi_io_streams_stream_status_t)(unsafe.Pointer(&ret.val))
...
func WasiIoStreamsCheckWrite(this uint32) Result[uint64, WasiIoStreamsWriteError] {
  ...
  lower_this_val := C.uint32_t(this)
  lower_this = lower_this_val
  var ret C.echo_result_u64_wasi_io_streams_write_error_t
...
func WasiIoStreamsWrite(this uint32, contents []uint8) Result[struct{}, WasiIoStreamsWriteError] {
  ...
  lower_this_val := C.uint32_t(this)
  lower_this = lower_this_val
  var lower_contents C.echo_list_u8_t
  if len(contents) == 0 {
  ...
  defer C.echo_list_u8_free(&lower_contents)
  var ret C.echo_result_void_wasi_io_streams_write_error_t
...
func WasiHttpTypesNewFields(entries []WasiHttpTypesTuple2StringListU8TT) uint32 {
  var lower_entries C.echo_list_tuple2_string_list_u8_t
  if len(entries) == 0 {
    lower_entries.ptr = nil
    lower_entries.len = 0
  } else {
    var empty_lower_entries C.echo_tuple2_string_list_u8_t
    lower_entries.ptr = (*C.echo_tuple2_string_list_u8_t)(C.malloc(C.size_t(len(entries)) * C.size_t(unsafe.Sizeof(empty_lower_entries))))
    lower_entries.len = C.size_t(len(entries))
    for lower_entries_i := range entries {
      lower_entries_ptr := (*C.echo_tuple2_string_list_u8_t)(unsafe.Pointer(uintptr(unsafe.Pointer(lower_entries.ptr)) +
      uintptr(lower_entries_i)*unsafe.Sizeof(empty_lower_entries)))
      var lower_entries_ptr_value C.echo_tuple2_string_list_u8_t
      var lower_entries_ptr_value_f0 C.echo_string_t
      ...
      var lower_entries_ptr_value_f1 C.echo_list_u8_t
  ...
  defer C.echo_list_tuple2_string_list_u8_free(&lower_entries)
...
func WasiHttpTypesFieldsGet(fields uint32, name string) [][]uint8 {
  ...
  lower_fields_val := C.uint32_t(fields)
  lower_fields = lower_fields_val
  var lower_name C.echo_string_t
  
  // use unsafe.Pointer to avoid copy
  lower_name.ptr = (*uint8)(unsafe.Pointer(C.CString(name)))
  lower_name.len = C.size_t(len(name))
  defer C.echo_string_free(&lower_name)
  var ret C.echo_list_list_u8_t
  C.wasi_http_types_fields_get(lower_fields, &lower_name, &ret)
  var lift_ret [][]uint8
  lift_ret = make([][]uint8, ret.len)
  if ret.len > 0 {
    for lift_ret_i := 0; lift_ret_i < int(ret.len); lift_ret_i++ {
      var empty_lift_ret C.echo_list_u8_t
      lift_ret_ptr := *(*C.echo_list_u8_t)(unsafe.Pointer(uintptr(unsafe.Pointer(ret.ptr)) +
      uintptr(lift_ret_i)*unsafe.Sizeof(empty_lift_ret)))
...
func WasiHttpTypesFieldsSet(fields uint32, name string, value [][]uint8) {
  ...
  lower_name.len = C.size_t(len(name))
  defer C.echo_string_free(&lower_name)
  var lower_value C.echo_list_list_u8_t
  if len(value) == 0 {
    lower_value.ptr = nil
    lower_value.len = 0
  } else {
    var empty_lower_value C.echo_list_u8_t
    lower_value.ptr = (*C.echo_list_u8_t)(C.malloc(C.size_t(len(value)) * C.size_t(unsafe.Sizeof(empty_lower_value))))
    lower_value.len = C.size_t(len(value))
    for lower_value_i := range value {
      lower_value_ptr := (*C.echo_list_u8_t)(unsafe.Pointer(uintptr(unsafe.Pointer(lower_value.ptr)) +
  ...
  defer C.echo_list_list_u8_free(&lower_value)
...
func WasiHttpTypesFieldsAppend(fields uint32, name string, value []uint8) {
  ...
  lower_name.len = C.size_t(len(name))
  defer C.echo_string_free(&lower_name)
  var lower_value C.echo_list_u8_t
  if len(value) == 0 {
    lower_value.ptr = nil
    lower_value.len = 0
  } else {
  ...
  defer C.echo_list_u8_free(&lower_value)
...
func WasiHttpTypesFieldsEntries(fields uint32) []WasiHttpTypesTuple2StringListU8TT {
  ...
  lower_fields_val := C.uint32_t(fields)
  lower_fields = lower_fields_val
  var ret C.echo_list_tuple2_string_list_u8_t
  ...
  if ret.len > 0 {
    for lift_ret_i := 0; lift_ret_i < int(ret.len); lift_ret_i++ {
      var empty_lift_ret C.echo_tuple2_string_list_u8_t
      lift_ret_ptr := *(*C.echo_tuple2_string_list_u8_t)(unsafe.Pointer(uintptr(unsafe.Pointer(ret.ptr)) +
      uintptr(lift_ret_i)*unsafe.Sizeof(empty_lift_ret)))
...
func WasiHttpTypesFinishIncomingStream(s uint32) Option[uint32] {
  ...
  lower_s = lower_s_val
  var ret C.echo_option_wasi_http_types_future_trailers_t
...
func WasiHttpTypesFutureTrailersGet(f uint32) Option[Result[uint32, WasiHttpTypesError]] {
  ...
  lower_f_val := C.uint32_t(f)
  lower_f = lower_f_val
  var ret C.echo_option_result_wasi_http_types_trailers_wasi_http_types_error_t
  ...
  if ret.is_some {
    ...
    if ret.val.is_err {
      ...
      if lift_ret_val_ptr.tag == 0 {
        lift_ret_val_val_ptr := *(*C.echo_string_t)(unsafe.Pointer(&lift_ret_val_ptr.val))
...
func WasiHttpTypesFutureWriteTrailersResultGet(f uint32) Option[Result[struct{}, WasiHttpTypesError]] {
  ...
  lower_f_val := C.uint32_t(f)
  lower_f = lower_f_val
  var ret C.echo_option_result_void_wasi_http_types_error_t
...
func WasiHttpTypesIncomingRequestMethod(request uint32) WasiHttpTypesMethod {
  ...
  if ret.tag == 9 {
    lift_ret_ptr := *(*C.echo_string_t)(unsafe.Pointer(&ret.val))
...
func WasiHttpTypesIncomingRequestPathWithQuery(request uint32) Option[string] {
  ...
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.echo_option_string_t
...
func WasiHttpTypesIncomingRequestScheme(request uint32) Option[WasiHttpTypesScheme] {
  ...
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.echo_option_wasi_http_types_scheme_t
  ...
  if ret.is_some {
    ...
    if ret.val.tag == 2 {
      lift_ret_val_ptr := *(*C.echo_string_t)(unsafe.Pointer(&ret.val.val))
...
func WasiHttpTypesIncomingRequestConsume(request uint32) Result[uint32, struct{}] {
  ...
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.echo_result_wasi_http_types_incoming_stream_void_t
...
func WasiHttpTypesNewOutgoingRequest(method WasiHttpTypesMethod, path_with_query Option[string], scheme Option[WasiHttpTypesScheme], authority Option[string], headers uint32) Result[uint32, WasiHttpTypesError] {
  ...
  if method.Kind() == WasiHttpTypesMethodKindOther {
    ...
    lower_method.tag = 9
    lower_method_ptr := (*C.echo_string_t)(unsafe.Pointer(&lower_method.val))
    var lower_method_val C.echo_string_t
  ...
  var lower_path_with_query C.echo_option_string_t
  if path_with_query.IsSome() {
    var lower_path_with_query_val C.echo_string_t
  ...
  defer C.echo_option_string_free(&lower_path_with_query)
  var lower_scheme C.echo_option_wasi_http_types_scheme_t
  if scheme.IsSome() {
    ...
    if scheme.Unwrap().Kind() == WasiHttpTypesSchemeKindOther {
      ...
      lower_scheme_val_ptr := (*C.echo_string_t)(unsafe.Pointer(&lower_scheme_val.val))
      var lower_scheme_val_val C.echo_string_t
  ...
  defer C.echo_option_wasi_http_types_scheme_free(&lower_scheme)
  var lower_authority C.echo_option_string_t
  if authority.IsSome() {
    var lower_authority_val C.echo_string_t
  ...
  defer C.echo_option_string_free(&lower_authority)
  ...
  var ret C.echo_result_wasi_http_types_outgoing_request_wasi_http_types_error_t
  ...
  if ret.is_err {
    ...
    if lift_ret_ptr.tag == 0 {
      lift_ret_val_ptr := *(*C.echo_string_t)(unsafe.Pointer(&lift_ret_ptr.val))
      var lift_ret_val_val string
      lift_ret_val_val = C.GoStringN((*C.char)(unsafe.Pointer(lift_ret_val_ptr.ptr)), C.int(lift_ret_val_ptr.len))
...
func WasiHttpTypesOutgoingRequestWrite(request uint32) Result[uint32, struct{}] {
  ...
  lower_request_val := C.uint32_t(request)
  lower_request = lower_request_val
  var ret C.echo_result_wasi_http_types_outgoing_stream_void_t
...
func WasiHttpTypesSetResponseOutparam(param uint32, response Result[uint32, WasiHttpTypesError]) Result[struct{}, struct{}] {
  ...
  var lower_response C.echo_result_wasi_http_types_outgoing_response_wasi_http_types_error_t
  ...
  if response.IsOk() {
    ...
    *lower_response_ptr = lower_response_val
    ...
    if response.UnwrapErr().Kind() == WasiHttpTypesErrorKindInvalidUrl {
      ...
      lower_response_val_ptr := (*C.echo_string_t)(unsafe.Pointer(&lower_response_val.val))
      var lower_response_val_val C.echo_string_t
  ...
  defer C.echo_result_wasi_http_types_outgoing_response_wasi_http_types_error_free(&lower_response)
  var ret C.echo_result_void_void_t
...
func WasiHttpTypesNewOutgoingResponse(status_code uint16, headers uint32) Result[uint32, WasiHttpTypesError] {
  ...
  lower_headers_val = lower_headers_val_val
  lower_headers = lower_headers_val
  var ret C.echo_result_wasi_http_types_outgoing_response_wasi_http_types_error_t
...
func WasiHttpTypesFutureIncomingResponseGet(f uint32) Option[Result[uint32, WasiHttpTypesError]] {
  ...
  lower_f_val := C.uint32_t(f)
  lower_f = lower_f_val
  var ret C.echo_option_result_wasi_http_types_incoming_response_wasi_http_types_error_t
